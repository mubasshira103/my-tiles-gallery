...
const PremiumTiles = async () => {
  ...
  return (
    <div className="max-w-11/12 mx-auto">
      <h1 className="text-2xl text-black text-center m-10 font-bold my-8">
        Luxury Vein Collection
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3 sm:gap-3">
        {tilesData.map((tiles) => (
